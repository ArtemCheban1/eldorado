        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4">
            ...
            <div className="space-y-2">
              ...
              <a
                href="/georeference"
                className="w-full bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded transition-colors text-sm font-medium flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
